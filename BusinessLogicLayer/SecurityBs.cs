...
namespace BusinessLogicLayer
{
    ...
    public class CouponHubMembershipProvider : MembershipProvider
    {
        UserDB db;

        public CouponHubMembershipProvider()
        {
            db = new UserDB();
        }
    ...
    public class CouponHubRoleProvider : RoleProvider
    {
        UserDB db;

        public CouponHubRoleProvider()
        {
            db = new UserDB();
        }
